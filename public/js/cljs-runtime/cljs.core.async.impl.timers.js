...
var i_42856 = (0);
while(true){
if((i_42856 < arr.length)){
(arr[i_42856] = null);

var G__42857 = (i_42856 + (1));
i_42856 = G__42857;
continue;
} else {
}
...
var i_42869 = (self__.level + (1));
while(true){
if((i_42869 <= (new_level + (1)))){
(update[i_42869] = self__.header);

var G__42870 = (i_42869 + (1));
i_42869 = G__42870;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_42875 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42875[i]));
} else {
x__$2.forward.push((((i < links_42875.length))?(links_42875[i]):null));
}

if((i < links_42875.length)){
(links_42875[i] = x__$2);
} else {
links_42875.push(x__$2);
}
...
var i_42882 = (0);
while(true){
if((i_42882 <= self__.level)){
var links_42885 = (update[i_42882]).forward;
if((x__$1 === (((i_42882 < links_42885.length))?(links_42885[i_42882]):null))){
(links_42885[i_42882] = (x__$1.forward[i_42882]));

var G__42886 = (i_42882 + (1));
i_42882 = G__42886;
continue;
} else {
var G__42887 = (i_42882 + (1));
i_42882 = G__42887;
continue;
}
} else {
...
var G__42889 = nx;
var G__42890 = (level__$1 - (1));
x = G__42889;
level__$1 = G__42890;
continue;
} else {
var G__42891 = x;
var G__42892 = (level__$1 - (1));
x = G__42891;
level__$1 = G__42892;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__42894 = nx;
var G__42895 = (level__$1 - (1));
x = G__42894;
level__$1 = G__42895;
continue;
} else {
var G__42896 = x;
var G__42897 = (level__$1 - (1));
x = G__42896;
level__$1 = G__42897;
continue;
}
