...
if((x instanceof cljs.core.Keyword)){
var G__47872 = spec;
var G__47873 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__47872,G__47873) : f.call(null,G__47872,G__47873));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__47874 = spec;
var G__47875 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__47874,G__47875) : f.call(null,G__47874,G__47875));
} else {
return x;
...
if(typeof x === 'number'){
var G__47878 = spec;
var G__47879 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__47878,G__47879) : f.call(null,G__47878,G__47879));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e47880){if((e47880 instanceof Error)){
var ___$1 = e47880;
return x;
} else {
throw e47880;
...
}catch (e47881){if((e47881 instanceof Error)){
var ___$1 = e47881;
return x;
} else {
throw e47881;
...
}catch (e47887){if((e47887 instanceof Error)){
var ___$1 = e47887;
return x;
} else {
throw e47887;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__47948,x){
var map__47949 = p__47948;
var map__47949__$1 = cljs.core.__destructure_map(map__47949);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47949__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__47950,x){
var map__47951 = p__47950;
var map__47951__$1 = cljs.core.__destructure_map(map__47951);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47951__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__47964,x){
var map__47965 = p__47964;
var map__47965__$1 = cljs.core.__destructure_map(map__47965);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47965__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
