...
var G__51167 = o;
goog.object.set(G__51167,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51193__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51193 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51194__i = 0, G__51194__a = new Array(arguments.length -  0);
while (G__51194__i < G__51194__a.length) {G__51194__a[G__51194__i] = arguments[G__51194__i + 0]; ++G__51194__i;}
  args = new cljs.core.IndexedSeq(G__51194__a,0,null);
} 
return G__51193__delegate.call(this,args);};
G__51193.cljs$lang$maxFixedArity = 0;
G__51193.cljs$lang$applyTo = (function (arglist__51195){
var args = cljs.core.seq(arglist__51195);
return G__51193__delegate(args);
});
...
var G__51169 = o;
goog.object.set(G__51169,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51198__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51198 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51199__i = 0, G__51199__a = new Array(arguments.length -  0);
while (G__51199__i < G__51199__a.length) {G__51199__a[G__51199__i] = arguments[G__51199__i + 0]; ++G__51199__i;}
  args = new cljs.core.IndexedSeq(G__51199__a,0,null);
} 
return G__51198__delegate.call(this,args);};
G__51198.cljs$lang$maxFixedArity = 0;
G__51198.cljs$lang$applyTo = (function (arglist__51200){
var args = cljs.core.seq(arglist__51200);
return G__51198__delegate(args);
});
...
var G__51172 = props;
var G__51172__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51172,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51172);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51172__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51172__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51173 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51173,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51173;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51174){
var map__51175 = p__51174;
var map__51175__$1 = cljs.core.__destructure_map(map__51175);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51175__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51176_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51176_SHARP_);
}));
} else {
return null;
}
...
var vec__51178 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51178,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51178,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51178,(2),null);
...
var temp__5757__auto___51210 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___51210 == null)){
} else {
var key_51211 = temp__5757__auto___51210;
(jsprops.key = key_51211);
}
...
var temp__5757__auto___51212 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___51212 == null)){
} else {
var key_51213 = temp__5757__auto___51212;
(jsprops.key = key_51213);
}
...
var G__51182 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51182) : reagent.impl.template.as_element.call(null,G__51182));
} else {
var temp__5757__auto___51214 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___51214 == null)){
} else {
var key_51215 = temp__5757__auto___51214;
(jsprops.key = key_51215);
}
...
var G__51184 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__51184)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__51184)){
return x;
} else {
...
var len__4829__auto___51216 = arguments.length;
var i__4830__auto___51217 = (0);
while(true){
if((i__4830__auto___51217 < len__4829__auto___51216)){
args__4835__auto__.push((arguments[i__4830__auto___51217]));

var G__51218 = (i__4830__auto___51217 + (1));
i__4830__auto___51217 = G__51218;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51185){
var G__51186 = cljs.core.first(seq51185);
var seq51185__$1 = cljs.core.next(seq51185);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51186,seq51185__$1);
}));
...
break;
default:
var G__51221 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51221;
continue;
...
var ctx = ({});
var vec__51189 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51189,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51189,(1),null);
...
var G__51192 = (cljs.core.count(argv) - first_child);
switch (G__51192) {
case (0):
