...
var len__4829__auto___49676 = arguments.length;
var i__4830__auto___49677 = (0);
while(true){
if((i__4830__auto___49677 < len__4829__auto___49676)){
args_arr__4850__auto__.push((arguments[i__4830__auto___49677]));

var G__49678 = (i__4830__auto___49677 + (1));
i__4830__auto___49677 = G__49678;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.core.rrb_vector.catvec.cljs$lang$applyTo = (function (seq49598){
var G__49599 = cljs.core.first(seq49598);
var seq49598__$1 = cljs.core.next(seq49598);
var G__49600 = cljs.core.first(seq49598__$1);
var seq49598__$2 = cljs.core.next(seq49598__$1);
var G__49601 = cljs.core.first(seq49598__$2);
var seq49598__$3 = cljs.core.next(seq49598__$2);
var G__49602 = cljs.core.first(seq49598__$3);
var seq49598__$4 = cljs.core.next(seq49598__$3);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49599,G__49600,G__49601,G__49602,seq49598__$4);
}));
...
default:
var args_arr__4850__auto__ = [];
var len__4829__auto___49681 = arguments.length;
var i__4830__auto___49682 = (0);
while(true){
if((i__4830__auto___49682 < len__4829__auto___49681)){
args_arr__4850__auto__.push((arguments[i__4830__auto___49682]));

var G__49683 = (i__4830__auto___49682 + (1));
i__4830__auto___49682 = G__49683;
continue;
} else {
}
break;
...
var arr__49623 = [];
return (new clojure.core.rrb_vector.rrbt.Vector(0,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49623,null,null));
}));
...
return (new clojure.core.rrb_vector.rrbt.Vector(1,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49624,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$2 = (function (x1,x2){
var arr__49625 = [null,null];
(arr__49625[(0)] = x1);

(arr__49625[(1)] = x2);

return (new clojure.core.rrb_vector.rrbt.Vector(2,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49625,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$3 = (function (x1,x2,x3){
var arr__49628 = [null,null,null];
(arr__49628[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(3,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49628,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$4 = (function (x1,x2,x3,x4){
var arr__49629 = [null,null,null,null];
(arr__49629[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(4,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49629,null,null));
}));
...
/** @this {Function} */
(clojure.core.rrb_vector.vector.cljs$lang$applyTo = (function (seq49617){
var G__49618 = cljs.core.first(seq49617);
var seq49617__$1 = cljs.core.next(seq49617);
var G__49619 = cljs.core.first(seq49617__$1);
var seq49617__$2 = cljs.core.next(seq49617__$1);
var G__49620 = cljs.core.first(seq49617__$2);
var seq49617__$3 = cljs.core.next(seq49617__$2);
var G__49621 = cljs.core.first(seq49617__$3);
var seq49617__$4 = cljs.core.next(seq49617__$3);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49618,G__49619,G__49620,G__49621,seq49617__$4);
}));
